...
const browser=bowser.getParser(window.navigator.userAgent),getDomain=()=>{let e=document.currentScript,t=e.dataset.domain;return t},getLocation=async()=>{try{let e=await fetch("https://ipwho.is/"),t=await e.json(),r=t.country,a=t.city,n=t.flag.emoji;return{country:r,city:a,flag:n}}catch(o){return{country:"Unknown",city:"Unknown",flag:"\uD83C\uDF0D"}}},getReferrer=()=>{let e=document.referrer;return e},getDevice=()=>{let e=browser.getPlatformType();return e},getBrowser=()=>{let e=browser.getBrowserName();return e},getOS=()=>{let e=browser.getOSName();return e},getTime=()=>{let e=Math.floor(Date.now()/1e3);return e},compileData=async()=>{try{if(sessionStorage.getItem("hasVisited"))return null;{sessionStorage.setItem("hasVisited","true");let e=getDomain(),t=await getLocation(),r=getReferrer(),a=getDevice(),n=getBrowser(),o=getOS(),i=getTime(),s={domain:e,location:t,referrer:r,device:a,browser:n,os:o,time:i};return s}}catch(g){return null}},sendData=async e=>{let t=await compileData();try{t&&await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}catch(r){console.log("Error sending data to thandata server! \uD83D\uDE2D")}};sendData(api_url="/api/visit");