  ...
  return (function (t) {
      ...
      if (e(8)) {
        var r = e(32),
          ...
          It = {
            ...
            reverse: function () {
              for (
                var t, n = Pt(this).length, e = Math.floor(n / 2), r = 0;
                r < e;
          ...
          Vt = function (t, n, e) {
            return !(Ct(t, (n = m(n, !0))) && w(e) && b(e, "value")) ||
              b(e, "get") ||
              b(e, "set") ||
              e.configurable ||
        ...
        d(Gt, Bt),
          ...
          (t.exports = function (t, n, e, c) {
              ...
              ? ((p = e(function (t, e, r, i) {
                  ...
                  if (w(e)) {
                    if (
                      ...
                      return bt in e ? At(p, e) : Nt.call(p, e);
                    (o = e), (d = xt(r, n));
                    var y = e.byteLength;
                    if (void 0 === i) {
                  ...
                  for (
                    h(t, "_d", { b: o, o: d, l: u, e: a, v: new Q(o) });
                    l < a;
            ...
            h(p, gt, !0),
              ...
              "BYTES_PER_ELEMENT" in M || h(M, "BYTES_PER_ELEMENT", n),
              u(u.P, s, It),
              L(s),
              u(u.P + u.F * Mt, s, { set: Lt }),
              u(u.P + u.F * !E, s, Bt),
              r || M.toString == ht || (M.toString = ht),
              u(
                u.P +
                  u.F *
                    o(function () {
      ...
      t.exports = function (t, n, e, v, g, y) {
        ...
        if (
          ...
          F ||
            ...
            (w.constructor = b)),
            (O || A) && (M("delete"), M("has"), g && M("get")),
            (A || P) && M(S),
            y && w.clear && delete w.clear;
        } else
          (b = v.getConstructor(n, t, g, S)), u(b.prototype, e), (a.NEED = !0);
        return (
          d(b, t),
          (_[t] = b),
          i(i.G + i.W + i.F * (b != m), _),
          ...
          ("__proto__" in {}
            ? (function (t, n, r) {
                try {
                  (r = e(19)(
                    Function.call,
                    e(22).f(Object.prototype, "__proto__").set,
                    2
                  ))(t, []),
    ...
    function (t, n, e) {
      ...
      t.exports = function (t, n, e, p, v, g, y) {
        ...
        if (
          (E &&
            (S = f(E.call(new t()))) !== Object.prototype &&
            S.next &&
            (s(S, _, !0), r || "function" == typeof S[l] || u(S, l, d)),
          M &&
            O &&
            "values" !== O.name &&
            ((x = !0),
    ...
    function (t, n, e) {
      ...
      function z(t, n, e, r, i, o) {
        ...
        for (var a = t[R]._b, c = u + t[T], s = r(+i), f = 0; f < n; f++)
          a[c + f] = s[o ? f : n - f - 1];
      }
      if (u.ABV) {
        if (
          ...
          (n.compareVersion = function (t) {
            ...
            if ("string" == typeof i)
              return (
                ...
                n.indexOf(a.default.compareVersions(i, e, r)) > -1
              );
          }),
          (n.isOS = function (t) {
          ...
          },
          {
            ...
            describe: function (t) {
              var n = { name: "Opera Touch" },
                e =
                  i.default.getFirstMatch(/(?:opt)[\s/](\d+(\.?_?\d+)+)/i, t) ||
                  i.default.getFirstMatch(o, t);
              return e && (n.version = e), n;
            },
          },
      ...
      var u = [
        {
          ...
          describe: function (t) {
            ...
            return { name: o.OS_MAP.Roku, version: n };
          },
        },
        {
          ...
          describe: function (t) {
            ...
            return { name: o.OS_MAP.WindowsPhone, version: n };
          },
        },
        {
          test: [/windows /i],
          describe: function (t) {
            ...
            return { name: o.OS_MAP.Windows, version: n, versionName: e };
          },
        },
        {
        ...
        },
        {
          ...
          describe: function (t) {
            var n = i.default
              ...
              r = { name: o.OS_MAP.MacOS, version: n };
        ...
        },
        {
          ...
          describe: function (t) {
            var n = i.default
              ...
              .replace(/[_\s]/g, ".");
            return { name: o.OS_MAP.iOS, version: n };
          },
        },
        {
          test: function (t) {
          ...
          describe: function (t) {
            var n = i.default.getFirstMatch(/android[\s/-](\d+(\.\d+)*)/i, t),
              ...
              r = { name: o.OS_MAP.Android, version: n };
            return e && (r.versionName = e), r;
          },
        },
        {
        ...
        },
        {
          ...
          describe: function (t) {
            ...
            return { name: o.OS_MAP.BlackBerry, version: n };
          },
        },
        {
          test: [/bada/i],
          describe: function (t) {
            ...
            return { name: o.OS_MAP.Bada, version: n };
          },
        },
        {
          test: [/tizen/i],
          describe: function (t) {
            ...
            return { name: o.OS_MAP.Tizen, version: n };
          },
        },
        {
          test: [/linux/i],
        ...
        },
        {
          ...
          describe: function (t) {
            ...
            return { name: o.OS_MAP.PlayStation4, version: n };
          },
        },
      ];
      (n.default = u), (t.exports = n.default);
      ...
      var u = [
        ...
        },
        {
          ...
          describe: function (t) {
            var n = i.default.getFirstMatch(/(can-l01)/i, t) && "Nova",
              e = { type: o.PLATFORMS_MAP.mobile, vendor: "Huawei" };
        ...
        },
        {
          ...
          describe: function (t) {
            ...
            return { type: o.PLATFORMS_MAP.mobile, vendor: "Apple", model: n };
          },
        },
        {
      ...
      var u = [
        {
          ...
          describe: function (t) {
            ...
            return { name: o.ENGINE_MAP.EdgeHTML, version: n };
          },
        },
        {
          test: [/trident/i],
    ...
    function (t, n, e) {
      ...
      t.exports =
        ...
        e(2)(function () {
          ...
          ? function (t, n) {
              for (
                var e = a(t), s = arguments.length, f = 1, l = o.f, h = u.f;
                s > f;
    ...
    function (t, n, e) {
      ...
      e(131);
      var r,
        i = (r = e(303)) && r.__esModule ? r : { default: r };
    ...
    function (t, n, e) {
      ...
      var r = e(1),
        ...
        Z = function (t, n) {
          if (((t = w(t)), (n = _(n, !0)), t !== D || !i(V, n) || i(G, n))) {
            var e = N(t, n);
            return (
              !e || !i(V, n) || (i(t, L) && t[L][n]) || (e.enumerable = !0), e
            );
          }
        },
        $ = function (t) {
          for (var n, e = k(w(t)), r = [], o = 0; e.length > o; )
            i(V, (n = e[o++])) || n == L || n == c || r.push(n);
          return r;
        },
        tt = function (t) {
          for (
            var n, e = t === D, r = k(e ? G : w(t)), o = [], u = 0;
            r.length > u;

          )
            !i(V, (n = r[u++])) || (e && !i(D, n)) || o.push(V[n]);
          return o;
        };
      U ||
        (a(
        ...
        (e(47).f = X),
        (F.f = tt),
        o && !e(32) && a(D, "propertyIsEnumerable", X, !0),
        (p.f = function (t) {
          return Y(d(t));
        })),
        u(u.G + u.W + u.F * !U, { Symbol: T });
      for (
        var nt =
      ...
      u(u.S + u.F * ot, "Object", {
        ...
        T.prototype[B] || e(14)(T.prototype, B, T.prototype.valueOf),
        l(T, "Symbol"),
        l(Math, "Math", !0),
        l(r.JSON, "JSON", !0);
    },
          ...
          from: function (t) {
            ...
            if (
              ...
              for (l = m.call(h), e = new d(); !(i = l.next()).done; y++)
                s(e, y, g ? u(l, v, [i.value, y], !0) : i.value);
            return (e.length = y), e;
          },
        }
      );
          ...
          [
            ...
            function (t, n) {
              ...
              for (var S = 0, w = 0, _ = []; w < h.length; ) {
                ...
                if (
                  null === x ||
                  (M = l(a(m.lastIndex + (d ? 0 : w)), h.length)) === S
                )
                  w = u(h, w, g);
                else {
            ...
            (o._invoke = (function (t, n, e) {
              ...
              return function (i, o) {
                ...
                for (e.method = i, e.arg = o; ; ) {
                  ...
                  "throw" === c.type &&
                    ((r = d), (e.method = "throw"), (e.arg = c.arg));
                }
              };
            })(t, e, u)),
            o
...
const browser = bowser.getParser(window.navigator.userAgent),
  ...
  getLocation = async () => {
    try {
      let e = await fetch("https://ipwho.is/"),
        ...
        a = t.city,
        n = t.flag.emoji;
      return { country: r, city: a, flag: n };
    } catch (o) {
  ...
  getDevice = () => {
    let e = browser.getPlatformType();
    return e;
  },
  getBrowser = () => {
    let e = browser.getBrowserName();
    return e;
  },
  getOS = () => {
    let e = browser.getOSName();
    return e;
  },
  getTime = () => {
...
sendData((api_url = "https://thandata.vercel.app/api/visit"));
